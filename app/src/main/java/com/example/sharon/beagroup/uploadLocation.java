...
public class uploadLocation extends AsyncTask<String, Void, String>{
    ...
    @Override
    protected String doInBackground(String... params ) { //How: uploadLocation.execute(globalVariable.id, globalVariable.userLocation);
        String id = params[0];
        String userLocation = params[1];
        String check_code="";
        String result="";
        try{
            String uploadLocation_url = "http://140.113.73.42/uploadLocation.php";
