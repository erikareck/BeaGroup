...
public class InsertFriendList extends AsyncTask<String, Void, String> {
    ...
    @Override
    protected String doInBackground(String... params ) { //How: insertFriendList.execute(group_id, friend_id);
        ...
        try{
            String checkid_url = "http://140.113.73.42/insertFriendList.php";
